...
import { addCourse, deleteCourse, getAllCourse, getSpecificCourse, updateCourse } from "./course.controller.js";
...
courseRouter.get("/", auth(), getAllCourse);
...
courseRouter.put("/:id", auth(), validate("updateCourse"), updateCourse);
